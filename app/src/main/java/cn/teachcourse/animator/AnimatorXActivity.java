package cn.teachcourse.animator;
...
import static cn.teachcourse.R.id.animator_x_tv;

public class AnimatorXActivity extends AppCompatActivity {
    ...
    private void initView() {
        mTextView = (TextView) findViewById(animator_x_tv);
    }
