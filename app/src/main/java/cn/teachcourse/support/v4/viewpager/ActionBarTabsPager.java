package cn.teachcourse.support.v4.viewpager;
...
//        setSupportActionBar(myToolbar);
     ...
     * Intent that each tab will prepare.  This is not sufficient for switching
     * between pages.  So instead we make the content part of the tab host
     * 0dp high (it is not shown) and the TabsAdapter supplies its own dummy
     * view to prepare as the tab content.  It listens to changes in tabs, and takes
