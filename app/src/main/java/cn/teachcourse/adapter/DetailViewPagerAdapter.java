 ...
 * 首页的轮播图。
 */
public class DetailViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public DetailViewPagerAdapter(ViewPager headViewPager, Context mActivity, LinearLayout headView_ll_point) {
