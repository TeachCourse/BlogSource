...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	private ScrollView scrollView;// 宓屽鐨剆crollview
	...
	private void setParentScrollAble(boolean flag) {
		if (scrollView == null) {
			if (getParent() != null
				...
				((ScrollView) getParent().getParent())
	...
	/**
	 * 璁剧疆listview宓屽鍦╯crollview涓粴鍔ㄩ棶棰�	 */
	...
	public final boolean onInterceptTouchEvent(MotionEvent event) {
		...
		if (action == MotionEvent.ACTION_CANCEL
			...
			// 褰撴墜鎸囨澗寮�椂锛岃鐖禨crollView閲嶆柊鎷垮埌onTouch鏉冮�?
			setParentScrollAble(true);
			mIsBeingDragged = false;
			return false;
		} else if (action == MotionEvent.ACTION_MOVE
				|| action == MotionEvent.ACTION_DOWN) {
			// 褰撴寚瑙�?埌listview鐨勬椂鍊欙紝璁╃埗ScrollView浜ゅ嚭ontouch鏉冮檺锛屼篃灏辨槸璁╃埗scrollview 鍋滀綇涓嶈兘婊氬�?
