...
public class ExcellentStudent {
    ...
    public static final ExcellentStudent[] values = new ExcellentStudent[]{ZHAOYUN, ZHANGFEI, LIUBEI};

    private int num;
    private String name;
    private String profession;

    private ExcellentStudent(int num, String name, String profession) {
        this.num = num;
        this.name = name;
