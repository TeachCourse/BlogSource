...
public class AppCompatActivityDialog extends AppCompatActivity {
    private static final String TAG = "AppCompatActivityDialog";

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(createDialog(new TestDialogBean(TAG)), new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    }
