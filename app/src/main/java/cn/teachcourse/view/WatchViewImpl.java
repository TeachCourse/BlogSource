...
public class WatchViewImpl extends WatchView {
    ...
    public static class BuilderImpl extends cn.teachcourse.view.Builder {
        ...
        public Builder setHourWidth(float hourWidth) {
            this.hourWidth = hourWidth;
            return this;
        }

        public Builder setMinuteWidth(float minuteWidth) {
            this.minuteWidth = minuteWidth;
            return this;
        }

        public Builder setSecondWidth(float secondWidth) {
            this.secondWidth = secondWidth;
            return this;
        }

        public Builder setLongScaleColor(int longScaleColor) {
            this.longScaleColor = longScaleColor;
            return this;
        }

        public Builder setShortScaleColor(int shortScaleColor) {
        ...
        public WatchViewImpl create() {
            final WatchViewImpl watchView = new WatchViewImpl(context);
            /**
             * 设置大小
             */
