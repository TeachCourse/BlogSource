...
public class BasePopupWindActivity extends FragmentActivity {
    private int width;
    private int height;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       BasePopupWindActivity.Window window = intent != null ? (BasePopupWindActivity.Window) intent.getParcelableExtra(DATA_OF_BUNDLE) : null;
        if (window == null) {
